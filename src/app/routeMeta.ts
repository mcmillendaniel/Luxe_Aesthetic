...
export interface RouteMeta {
  ...
  canonical?: string
  /**
   * Optional social share image, as a path relative to the site root
   * (e.g. "/og-image.jpg"). Resolved to an absolute URL at prerender time —
   * the Open Graph spec requires absolute image URLs.
   */
  image?: string
